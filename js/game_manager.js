function GameManager(size, InputManager, Actuator, StorageManager) {
    ...
    //this.bg_music = document.getElementById("bg_music");
    ...
    this.inputManager.on("forceFail", (function() {
        this.over = true;
        this.actuator.message(false);
    }).bind(this));
    this.inputManager.on("forceWin", (function() {
        this.won = true;
...
GameManager.prototype.bindHover = function() {
